...
export const PropertySchema = z.object({
  ...
  property_type: z
    .enum(['residential', 'commercial', 'industrial', 'church'])
    .describe('Type of property'),
  year_built: z
    .number()
    .int()
    .positive()
    .describe('The year the property was built'),
  sq_ft: z.number().int().positive().describe('Square footage of the property'),
  description: z
    .string()
    .optional()
    .describe(
      'Additional details about the property, like HVAC age, roof type, etc.',
    ),
});
