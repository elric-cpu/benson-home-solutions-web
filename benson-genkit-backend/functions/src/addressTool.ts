...
export const validateAddressTool = ai.defineTool(
  ...
  async ({ address }) => {
    ...
    return {
      ...
      hasIncompleteComponents: (verdict as Record<string, unknown>)
        ?.hasIncompleteComponents,
      hasUnconfirmedComponents: (verdict as Record<string, unknown>)
        ?.hasUnconfirmedComponents,
      hasReplacedComponents: (verdict as Record<string, unknown>)
