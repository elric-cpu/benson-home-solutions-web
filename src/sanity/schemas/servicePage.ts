...
export const servicePage = defineType({
  ...
  fields: [
    ...
    defineField({ name: 'serviceArea', title: 'Service Areas', type: 'array', of: [{ type: 'reference', to: [{ type: 'areaPage' }] }] }),
    defineField({ name: 'ctaText', title: 'CTA Button Text', type: 'string', initialValue: 'Get a Free Estimate' }),
