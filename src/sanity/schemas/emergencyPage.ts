...
export const emergencyPage = defineType({
  ...
  type: 'document',
  fields: [
    defineField({ name: 'title', title: 'Page Title', type: 'string', initialValue: 'Emergency Services' }),
    ...
    defineField({ name: 'emergencyServices', title: 'Emergency Services List', type: 'array', of: [{ type: 'block' }] }),
    defineField({ name: 'responseTimeSLA', title: 'Response Time SLA', type: 'string', initialValue: 'On-site within 60 minutes' }),
