...
export const AREA_DATA: Record<string, AreaData> = {
  ...
  burns: {
    ...
    description: 'High-desert property maintenance and winterization in Burns and Harney County. Wildfire hardening, weatherization, and practical property protection. CCB #258533.',
    ...
    protectionFeatures: ['Wildfire Hardening', 'Deep Freeze Winterization', 'Commercial Asset Management', 'Church Property Support'],
  ...
  hines: {
    ...
    description: 'Expert property maintenance and winterization in Hines, Oregon. Extreme temperature protection and practical field service support.',
    ...
    protectionFeatures: ['Deep Freeze Protection', 'Wildfire Hardening', 'Moisture Control Planning', 'Local Service Priority'],
  ...
  keizer: {
    ...
    protectionDescription: 'Maintaining the value of Keizer homes through recurring upkeep, clear repair scopes, and rapid emergency response.',
