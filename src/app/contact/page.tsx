...
export default async function ContactPage() {
  ...
  return (
    <>
      ...
      >
        <Container>
          {page?.emergencyBannerText || `24/7 EMERGENCY? CALL ${BUSINESS.phone} IMMEDIATELY.`}
        </Container>
      </div>
      ...
      <Section className="bg-surface/50">
        <Container size="wide">
          <div className="grid gap-12 lg:grid-cols-2">
            ...
            <div>
              <div className="mb-8">
                <h2 className="mb-4 text-3xl font-black text-benson-text">Send Us a Message</h2>
                <p className="text-muted-foreground">
                  Fill out the form below and our team will get back to you shortly.
                  For immediate assistance, please use our 24/7 line.
                </p>
              </div>
              <ContactForm />
            </div>
            ...
            {/* Information Section */}
            <div>
              <h2 className="mb-8 text-3xl font-black text-benson-text">Contact Information</h2>
              <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-1">
                {page?.contactInfo?.map((info, idx) => (
                  <Card key={idx} className="border-benson-creamDark shadow-sm">
                    <CardContent className="p-6">
                      <h3 className="mb-3 text-lg font-bold text-benson-maroon">{info.title}</h3>
                  ...
                  <>
                    <Card className="border-benson-creamDark shadow-sm">
                      <CardContent className="p-6">
                        <h3 className="mb-3 text-lg font-bold text-benson-maroon">Service Areas</h3>
                        <div className="text-muted-foreground text-sm leading-relaxed">
                          <p><strong>Mid-Willamette Valley:</strong> Albany, Lebanon, Sweet Home, Corvallis, Salem.</p>
                          <p className="mt-2"><strong>Harney County:</strong> Burns, Riley, Drewsey, Denio, McDermitt.</p>
                        </div>
                      </CardContent>
                    </Card>
                    <Card className="border-benson-creamDark shadow-sm">
                      <CardContent className="p-6">
                        <h3 className="mb-3 text-lg font-bold text-benson-maroon">Business Details</h3>
                        <div className="text-muted-foreground text-sm leading-relaxed">
                          <p><strong>Phone:</strong> {BUSINESS.phone}</p>
                          <p><strong>Email:</strong> {BUSINESS.email}</p>
                          <p><strong>License:</strong> CCB #{BUSINESS.license}</p>
                          <p className="mt-2 italic">Licensed, Bonded, and Insured in the State of Oregon.</p>
                        </div>
                      </CardContent>
                    </Card>
                  </>
              ...
              {/* Trust Signal */}
              <div className="mt-8 rounded-xl border border-dashed border-benson-maroon/20 p-6 text-center">
                 <p className="text-sm font-bold text-benson-maroon">
