...
const tools = [
  ...
  {
    title: 'Maintenance ROI Calc',
    href: '/tools/maintenance-roi',
    desc: 'Visualize the exponential cost of deferred maintenance and see the ROI of preventative action.',
    badge: 'Viral Utility',
    icon: '📈',
  },
  {
    title: 'Appliance Replacement',
    href: '/tools/appliance-replacement',
    desc: 'Calculate 2026 labor and installation rates for dishwasher, range, and refrigerator modernizations.',
    badge: 'Modernization',
    icon: '🔌',
  },
  {
  ...
  {
    title: 'Precision 3D Survey',
    href: '/tools/spatial-data',
    desc: 'Access 1mm-accurate LiDAR scans of your building envelope. Review floor plans, ANSI-compliant measurements, and structural documentation.',
    badge: 'Integrated',
    icon: '📐',
  },
  {
    title: 'Outdoor Living Designer',
    href: '/tools/outdoor-living',
    desc: 'Design and estimate your custom outdoor living space with integrated 2026 material price indexes. Available for active assessments.',
    badge: 'Beta',
    icon: '🌳',
  },
  {
    ...
    desc: 'High-fidelity acoustic modeling and spatial design for media environments. Optimized for Dolby Atmos 2026 standards.',
    badge: 'Integrated',
    icon: '🎬',
  },
];
