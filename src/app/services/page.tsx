...
const services = [
  ...
  },
  {
    ...
    desc: 'High-efficiency window and door replacements that harden your building envelope. We handle both residential and commercial installations with trade precision.',
    icon: '🪟',
    features: [
  ...
  },
  {
    ...
    desc: 'Controlled selective and structural demolition. We provide the professional oversight needed for safe debris management and site stabilization.',
    icon: '🚜',
    features: [
  ...
  },
  {
    ...
    desc: 'Science-based mold mitigation following IICRC S520 standards. We identify the moisture source, stabilize the environment, and provide post-remediation verification.',
    icon: '🧫',
    features: [
  ...
  {
    title: 'Sitework & Utilities',
    href: '/services/sitework',
    desc: 'Complete residential sitework including driveway installations, utility replacements, and site grading. We ensure your property drainage is forensic-grade.',
    icon: '🧱',
    features: [
  ...
  },
  {
    ...
    desc: 'Rapid turnarounds for tenant move-in/move-out prep. From trash-outs to high-fidelity interior refreshes, we keep your rental assets producing revenue.',
    icon: '🔑',
    features: [
      'Move-in/out refreshes',
      'Trash-out services',
      'Structural board-ups',
      'Lock changes',
      'Weatherization',
    ],
  },
